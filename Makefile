...
OBJS = ErrorHandler.o Base64.o Descriptor.o File.o Logger.o IPComm.o TCPConn.o SSLConn.o URL.o MIMEFraming.o HTTPFraming.o MsgHdr.o SSLContext.o TCPSession.o
